...
void main() => runApp(AndroidMobile5());

class AndroidMobile5 extends StatelessWidget {
  @override
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _buildBody(BuildContext context) {
    Query baby = Firestore.instance
        .collection('baby')
        .where("coin_type", isEqualTo: "copper");
  ...
  Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
    ...
    String coinurl = 'https://i.gifer.com/SrDY.gif';
    return Container(
      child: Padding(
