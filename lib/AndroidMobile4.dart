...
void main() => runApp(AndroidMobile4());
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _buildBody(BuildContext context) {
    Query baby = Firestore.instance
        .collection('baby')
        .where("coin_type", isEqualTo: "silver");
  ...
  Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
    ...
    String coinurl =
        'https://cdn.lowgif.com/full/3529262405e26672-3d-rotating-coin-silver-gamepro-market.gif';
    return Container(
      child: Padding(
